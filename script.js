 ...
 * @Last modified time: 2019-03-13T14:38:55-07:00
 */
...
function analyze(html) {
  ...
  let tests = {
    ...
    whois: (page, callback) => {
      ...
      http.open('GET', 'https://www.whoisxmlapi.com/whoisserver/WhoisService?domainName='+encodeURI(document.getElementById('domainName').value)+'&outputFormat=json', true)
      http.send()
    },
